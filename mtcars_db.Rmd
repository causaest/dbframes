...
#' 
#' This function adds an `id` column to an input data frame, with IDs as 
#' character strings, ranging from 1 up to the number of rows.
#' 
add_idcol <- function(x) {
...
```{r}
specs_table <- x[, c("id", "mpg", "disp", "hp", "drat", "wt", "qsec")]
head(specs_table)
```
